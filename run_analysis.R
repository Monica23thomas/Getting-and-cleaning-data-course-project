...
# Step 2: Download and unzip dataset if not already present
...
# Step 4: Merge training and test data
...
# Step 8: Create a second tidy data set with the average of each variable
...
# Done
message("Tidy dataset created: tidy_data.txt")
